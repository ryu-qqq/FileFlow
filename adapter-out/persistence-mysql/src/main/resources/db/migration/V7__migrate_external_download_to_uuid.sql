-- External Download 테이블을 UUID v7로 마이그레이션
...
-- 2. ExternalDownload 테이블 (UUID v7)
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='외부 다운로드 요청 (UUID v7)';

-- 3. ExternalDownloadOutbox 테이블 (UUID v7)
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='외부 다운로드 Outbox (SQS 발행용, UUID v7)';
