...
/**
 * File Asset ID
 * File Asset의 고유 식별자 (Value Object)
 *
 ...
 * </ul>
 *
 * @param value File Asset ID (양수)
 *
 * @author Sangwon Ryu
 * @since 1.0.0
 */
public record FileAssetId(Long value) {
    ...
    public FileAssetId {
        if (value == null || value <= 0) {
            throw new IllegalArgumentException("FileAssetId must be positive");
        }
    }
     ...
     * 정적 팩토리 메서드
     *
     * @param value File Asset ID
     * @return FileAssetId
     */
    public static FileAssetId of(Long value) {
