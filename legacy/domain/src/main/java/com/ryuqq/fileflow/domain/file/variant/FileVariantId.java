...
/**
 * File Variant ID
 * File Variant의 고유 식별자 (Value Object)
 *
 ...
 * </ul>
 *
 * @param value File Variant ID (양수)
 *
 * @author Sangwon Ryu
 * @since 1.0.0
 */
public record FileVariantId(Long value) {
    ...
    public FileVariantId {
        if (value == null || value <= 0) {
            throw new IllegalArgumentException("FileVariantId must be positive");
        }
    }
     ...
     * 정적 팩토리 메서드
     *
     * @param value File Variant ID
     * @return FileVariantId
     */
    public static FileVariantId of(Long value) {
        return new FileVariantId(value);
    }
