...
/**
 * Save ExtractedData Port (출력 포트)
 *
 * <p><strong>역할</strong>: ExtractedData 저장을 위한 출력 인터페이스</p>
 ...
 * @author Sangwon Ryu
 * @since 1.0.0
 * @see com.ryuqq.fileflow.domain.file.extraction.ExtractedData
 */
public interface SaveExtractedDataPort {

    /**
     * ExtractedData 저장
     *
     * <p>신규 생성 또는 기존 ExtractedData 업데이트</p>
     *
     * @param extractedData 저장할 ExtractedData (Domain)
     * @return 저장된 ExtractedData (ID 할당됨)
     */
    ExtractedData save(ExtractedData extractedData);
}
