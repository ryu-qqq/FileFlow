// ========================================
// Bootstrap: Upload Scheduler Application
// ========================================
// Runnable Spring Boot application for Upload Session Expiration
...
// ========================================
tasks.bootJar {
    archiveFileName.set("${project.rootProject.name}-scheduler-upload.jar")

    manifest {
        attributes(
            mapOf(
                "Implementation-Title" to "fileflow-scheduler-upload",
