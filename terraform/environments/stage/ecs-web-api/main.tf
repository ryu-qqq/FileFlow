...
# ========================================
# REST API server (No Auto Scaling)
# Using Infrastructure modules
# Access: API Gateway (external) / Service Discovery (internal)
# Service Discovery DNS: web-api-stage.connectly.local
# ========================================
...
resource "aws_kms_key" "logs" {
  description             = "KMS key for FileFlow web-api-stage CloudWatch logs encryption"
