# ========================================
# ECS Cluster for FileFlow (Stage)
# ========================================
# Dedicated ECS Cluster (not shared)
# Naming: fileflow-cluster-stage
# ========================================
...
resource "aws_ssm_parameter" "cluster_arn" {
  name        = "/${var.project_name}/ecs-stage/cluster-arn"
  description = "FileFlow ECS cluster ARN (stage)"
  type        = "String"
...
resource "aws_ssm_parameter" "cluster_name" {
  ...
  description = "FileFlow ECS cluster name (stage)"
  type        = "String"
