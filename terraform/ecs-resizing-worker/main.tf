...
resource "aws_kms_key" "logs" {
  description             = "KMS key for FileFlow resizing-worker CloudWatch logs encryption"
...
module "resizing_worker_service" {
  ...
  # No Auto Scaling for resizing-worker (can be enabled for SQS-based scaling)
