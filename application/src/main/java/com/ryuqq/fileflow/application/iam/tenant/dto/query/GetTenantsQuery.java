...
/**
 * GetTenantsQuery - Tenant 목록 조회 Query
 *
 ...
 * PageResponse<TenantResponse> tenants = getTenantsUseCase.execute(query);
 * }</pre>
 *
 * <p><strong>사용 예시 - Cursor-based:</strong></p>
 * <pre>{@code
 * GetTenantsQuery query = new GetTenantsQuery(null, 20, "cursor-value", null, null);
 * SliceResponse<TenantResponse> tenants = getTenantsUseCase.execute(query);
 * }</pre>
 *
