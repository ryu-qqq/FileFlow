...
public class InitSingleUploadService implements InitSingleUploadUseCase {
    ...
    private final SingleUploadAssembler assembler;
    ...
    public InitSingleUploadService(
            ...
            SingleUploadAssembler assembler,
    ...
    public InitSingleUploadResponse execute(InitSingleUploadCommand command) {
        // 1. Command → Domain (CommandFactory)
        SingleUploadSession newSession = commandFactory.createSingleUploadSession(command);
        ...
        return assembler.toResponseForInit(session);
    }
    ...
    private SingleUploadSession findOrCreateSession(SingleUploadSession newSession) {
        return uploadSessionReadManager
