...
/**
 * SoftDeleteOrganizationCommand - Organization 소프트 삭제 Command DTO
 *
 * <p>Organization을 소프트 삭제하기 위한 입력 데이터를 담는 불변 Command 객체입니다.
 ...
 * }</pre>
 *
 * @param organizationId 삭제할 Organization ID (필수)
 * @author ryu-qqq
 * @since 2025-10-22
 */
public record SoftDeleteOrganizationCommand(
     ...
     *
     * @throws IllegalArgumentException organizationId가 null이거나 양수가 아닌 경우
     * @author ryu-qqq
     * @since 2025-10-22
     */
    public SoftDeleteOrganizationCommand {
