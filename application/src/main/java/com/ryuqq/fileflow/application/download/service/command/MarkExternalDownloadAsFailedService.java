 ...
 *
 * <ul>
 *   <li>ExternalDownload 조회 (ReadManager)
...
public class MarkExternalDownloadAsFailedService implements MarkExternalDownloadAsFailedUseCase {
    ...
    public void markAsFailed(String externalDownloadId, String errorMessage) {
        ...
        Optional<ExternalDownload> downloadOpt =
                externalDownloadReadManager.findById(ExternalDownloadId.of(externalDownloadId));
        ...
        boolean processed = commandFactory.markAsFailed(download, errorMessage, defaultFileAssetId);
