 ...
 *
 * <p>업로드 세션의 상세 정보를 반환합니다. Multipart 세션의 경우 Part 정보를 포함합니다. REST API Layer와의 결합도를 낮추기 위해 status를
 * String으로 설계.
 *
...
public record UploadSessionDetailResponse(
     ...
     */
    public record PartDetailResponse(int partNumber, String etag, long size, Instant uploadedAt) {
