...
class ExternalDownloadMessageManagerTest {
    ...
    class PublishFromEventTest {
        ...
        void shouldPublishMessageFromEvent() {
            ...
            ExternalDownloadRegisteredEvent event =
                    createEvent(1L, "https://example.com/image.jpg");
        ...
        void shouldReturnTrueOnSuccess() {
            // given
            ExternalDownloadRegisteredEvent event = createEvent(2L, "https://example.com/test.png");
        ...
        void shouldReturnFalseOnFailure() {
            // given
            ExternalDownloadRegisteredEvent event = createEvent(3L, "https://example.com/fail.jpg");
    ...
    private ExternalDownloadRegisteredEvent createEvent(Long downloadId, String sourceUrl) {
