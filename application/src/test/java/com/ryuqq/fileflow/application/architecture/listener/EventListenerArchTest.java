package com.ryuqq.fileflow.application.architecture.listener;
 ...
 *
 * <p>핵심 철학: Listener는 부가 작업만 처리, 예외 전파 금지
 */
        ...
        void eventListener_MustNotHaveTransactionalAnnotation() {
            ...
            ArchRule rule =
                    noClasses()
                            ...
                            .because(
                                    "EventListener는 @Transactional을 가지지 않아야 합니다. "
        ...
        void eventListener_MustNotHaveAsyncAnnotation() {
            ...
            ArchRule rule =
                    noClasses()
                            ...
                            .because(
                                    "EventListener는 동기 처리를 기본으로 합니다. "
        ...
        void eventListener_MustNotDependOnPorts() {
            ...
            ArchRule rule =
                    noClasses()
                            ...
                            .because(
                                    "EventListener는 Port를 주입받지 않아야 합니다. "
        ...
        void eventListener_MustNotDependOnRepositories() {
            ...
            ArchRule rule =
                    noClasses()
                            ...
                            .because(
                                    "EventListener는 Repository를 주입받지 않아야 합니다. "
                                            + "DB 작업이 필요하면 별도 서비스를 호출하세요.");
