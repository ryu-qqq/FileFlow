// ========================================
// Bootstrap: Pipeline Scheduler Application
// ========================================
// Runnable Spring Boot application for Pipeline Outbox Scheduler
...
// ========================================
tasks.bootJar {
    archiveFileName.set("${project.rootProject.name}-scheduler-pipeline.jar")

    manifest {
        attributes(
            mapOf(
                "Implementation-Title" to "fileflow-scheduler-pipeline",
