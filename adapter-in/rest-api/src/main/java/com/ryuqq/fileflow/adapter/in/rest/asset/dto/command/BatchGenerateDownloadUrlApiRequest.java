 ...
 *
 * <p>여러 파일에 대한 S3 Presigned URL을 일괄 생성하기 위한 요청 정보를 담습니다.
 *
...
public record BatchGenerateDownloadUrlApiRequest(
        @Schema(description = "파일 자산 ID 목록 (최대 100개)", example = "[\"asset-1\", \"asset-2\"]", requiredMode = Schema.RequiredMode.REQUIRED)
        @NotEmpty(message = "파일 자산 ID 목록은 필수입니다")
