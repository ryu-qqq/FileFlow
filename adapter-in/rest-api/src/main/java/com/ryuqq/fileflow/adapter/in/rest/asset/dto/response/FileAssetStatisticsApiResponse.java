...
public record FileAssetStatisticsApiResponse(
        ...
        @Schema(description = "상태별 파일 수",
                example = "{\"PENDING\": 100, \"COMPLETED\": 800, \"FAILED\": 50}") Map<String, Long> statusCounts,
        @Schema(description = "카테고리별 파일 수",
                example = "{\"IMAGE\": 500, \"VIDEO\": 300, \"DOCUMENT\": 100}") Map<String, Long> categoryCounts) {
    /**
     * 생성자에서 방어적 복사 수행.
     */
