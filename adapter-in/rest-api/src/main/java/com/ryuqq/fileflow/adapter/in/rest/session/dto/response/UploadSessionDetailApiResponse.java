...
public record UploadSessionDetailApiResponse(
        ...
        @Schema(description = "S3 Multipart Upload ID (Multipart 전용)", nullable = true) String uploadId,
        @Schema(description = "전체 Part 개수 (Multipart 전용)", nullable = true) Integer totalParts,
        @Schema(description = "업로드 완료된 Part 개수 (Multipart 전용)", nullable = true) Integer uploadedParts,
        @Schema(description = "Part 정보 목록 (Multipart 전용)", nullable = true) List<PartDetailApiResponse> parts,
