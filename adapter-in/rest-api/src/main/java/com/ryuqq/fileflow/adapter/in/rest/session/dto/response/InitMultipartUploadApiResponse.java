 ...
 *
 * <p>
 * 생성된 세션 정보와 각 Part 정보 목록을 반환합니다.
 *
...
public record InitMultipartUploadApiResponse(
     ...
     */
    public static InitMultipartUploadApiResponse of(String sessionId, String uploadId,
            int totalParts, long partSize, Instant expiresAt, String bucket, String key,
            List<PartInfoApiResponse> parts) {
        return new InitMultipartUploadApiResponse(sessionId, uploadId, totalParts, partSize,
                expiresAt, bucket, key, parts);
    }
}
