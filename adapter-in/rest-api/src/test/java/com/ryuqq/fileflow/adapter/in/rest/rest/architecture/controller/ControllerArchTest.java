package com.ryuqq.fileflow.adapter.in.rest.rest.architecture.controller;
...
class ControllerArchTest {
    ...
    void controller_MustNotCreateDomainObjects() {
        ArchRule rule = noClasses()
            .that().resideInAPackage("..controller..")
            .and().haveSimpleNameNotEndingWith("GlobalExceptionHandler")
            .should().dependOnClassesThat().resideInAPackage("..domain..")
            .because("Controller는 Domain 객체를 직접 생성/조작하지 않습니다. UseCase를 통해 간접 호출하세요. (예외: GlobalExceptionHandler는 DomainException 처리 허용)");
