...
class CreateOrganizationRequestTest {
    ...
    class TenantIdValidation {
        ...
        void tenantId_null_shouldFail() {
            // Given
            CreateOrganizationRequest request = new CreateOrganizationRequest(null, "ORG001", "Test Org");
        ...
        void tenantId_empty_shouldFail() {
            // Given
            CreateOrganizationRequest request = new CreateOrganizationRequest("", "ORG001", "Test Org");
            ...
            ConstraintViolation<CreateOrganizationRequest> violation = violations.iterator().next();
    ...
    class OrgCodeValidation {
        ...
        void orgCode_null_shouldFail() {
            // Given
            CreateOrganizationRequest request = new CreateOrganizationRequest("tenant-123", null, "Test Org");
        ...
        void orgCode_empty_shouldFail() {
            // Given
            CreateOrganizationRequest request = new CreateOrganizationRequest("tenant-123", "", "Test Org");
    ...
    class NameValidation {
        ...
        void name_null_shouldFail() {
            // Given
            CreateOrganizationRequest request = new CreateOrganizationRequest("tenant-123", "ORG001", null);
        ...
        void name_empty_shouldFail() {
            // Given
            CreateOrganizationRequest request = new CreateOrganizationRequest("tenant-123", "ORG001", "");
    ...
    class SuccessCase {
        ...
        void minLengthFields_shouldPass() {
            // Given
            CreateOrganizationRequest request = new CreateOrganizationRequest("t", "O", "N");
    ...
    class RecordImmutability {
        ...
        void sameValues_shouldBeEqual() {
            // Given
            CreateOrganizationRequest request1 = new CreateOrganizationRequest("t1", "ORG1", "Org A");
            CreateOrganizationRequest request2 = new CreateOrganizationRequest("t1", "ORG1", "Org A");
        ...
        void differentValues_shouldNotBeEqual() {
            // Given
            CreateOrganizationRequest request1 = new CreateOrganizationRequest("t1", "ORG1", "Org A");
            CreateOrganizationRequest request2 = new CreateOrganizationRequest("t2", "ORG2", "Org B");
