...
class TransformCallbackOutboxSchedulerTest {
    ...
    @BeforeEach
    void setUp() {
        SchedulerProperties.TransformCallbackOutbox config =
    ...
    class ProcessOutboxTest {
        ...
        void processOutbox_PartialBatch_SingleCall() {
            ...
            assertThat(result.success()).isEqualTo(18);
        ...
        void processOutbox_FullBatch_ContinuesLoop() {
            ...
            given(useCase.execute(BATCH_SIZE))
                    ...
                    .willReturn(SchedulerBatchProcessingResult.of(15, 13, 2));

            // when
            SchedulerBatchProcessingResult result = sut.processOutbox();

            // then
            assertThat(result.total()).isEqualTo(65);
            assertThat(result.success()).isEqualTo(63);
            assertThat(result.failed()).isEqualTo(2);
