...
import com.ryuqq.fileflow.domain.file.fixture.FileFixture;
...
class FileTest {
    ...
    void shouldMutateStatusWhenMarkAsUploading() {
        // Given
        File file = com.ryuqq.fileflow.domain.file.fixture.FileFixture.aFile()
                .status(com.ryuqq.fileflow.domain.file.fixture.FileStatusFixture.pending())
                .build();
        ...
        // Then - 동일한 객체가 변경됨
        assertThat(file.getStatus()).isEqualTo(com.ryuqq.fileflow.domain.file.fixture.FileStatusFixture.uploading());
    }
    ...
    void shouldMutateStatusWhenMarkAsCompleted() {
        // Given
        File file = com.ryuqq.fileflow.domain.file.fixture.FileFixture.aFile()
                .status(com.ryuqq.fileflow.domain.file.fixture.FileStatusFixture.uploading())
                .build();
        ...
        // Then - 동일한 객체가 변경됨
        assertThat(file.getStatus()).isEqualTo(com.ryuqq.fileflow.domain.file.fixture.FileStatusFixture.completed());
    }
    ...
    void shouldMutateStatusWhenMarkAsFailed() {
        ...
        // Then - 동일한 객체가 변경됨
        assertThat(file.getStatus()).isEqualTo(com.ryuqq.fileflow.domain.file.fixture.FileStatusFixture.failed());
    }
    ...
    void shouldReturnFileIdValueWithoutChaining() {
        ...
        File file = com.ryuqq.fileflow.domain.file.fixture.FileFixture.aFile().build();
