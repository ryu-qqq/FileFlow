...
class FileProcessingOutboxIdTest {
    ...
    class CreateTest {
        ...
        void shouldGenerateValidUuid() {
            // given & when
            FileProcessingOutboxId id1 = FileProcessingOutboxId.forNew();
            FileProcessingOutboxId id2 = FileProcessingOutboxId.forNew();
        ...
        void shouldCreateFromValidString() {
            ...
            // when
            FileProcessingOutboxId id = FileProcessingOutboxId.of(uuidString);
        ...
        void shouldThrowWhenValueIsNull() {
            ...
            // when & then
            assertThatThrownBy(() -> FileProcessingOutboxId.of(nullUuid))
                    .isInstanceOf(IllegalArgumentException.class)
                    .hasMessageContaining("FileProcessingOutboxId는 null일 수 없습니다");
        }
    }
    ...
    class EqualityTest {
        ...
        void shouldBeEqualWithSameUuid() {
            ...
            FileProcessingOutboxId id1 = FileProcessingOutboxId.of(uuid);
            FileProcessingOutboxId id2 = FileProcessingOutboxId.of(uuid);
