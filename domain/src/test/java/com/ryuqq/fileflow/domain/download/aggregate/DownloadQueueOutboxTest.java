...
@Tag("unit")
@DisplayName("DownloadQueueOutbox 단위 테스트")
class DownloadQueueOutboxTest {
    ...
    class ForNewTest {
        ...
        void forNew_InitializesPendingStatus() {
            ...
            assertThat(outbox.downloadTaskId()).isEqualTo("download-001");
    ...
    class EqualsHashCodeTest {
        ...
        void sameId_AreEqual() {
            DownloadQueueOutbox a =
                    DownloadQueueOutbox.forNew(
                            DownloadQueueOutboxId.of("outbox-001"), "download-001", NOW);
            DownloadQueueOutbox b =
                    DownloadQueueOutbox.forNew(
                            DownloadQueueOutboxId.of("outbox-001"), "download-002", NOW);
        ...
        void differentId_AreNotEqual() {
            ...
            DownloadQueueOutbox b =
                    DownloadQueueOutbox.forNew(
                            DownloadQueueOutboxId.of("outbox-002"), "download-001", NOW);
