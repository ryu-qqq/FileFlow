...
public record ImageFormat(ImageFormatType type, String extension, String mimeType) {
    ...
    public static final ImageFormat WEBP =
            new ImageFormat(ImageFormatType.WEBP, "webp", "image/webp");

    /** JPEG 포맷. 손실 압축, 사진에 적합. */
    public static final ImageFormat JPEG =
            new ImageFormat(ImageFormatType.JPEG, "jpg", "image/jpeg");
     ...
     *
     * <p>PNG 확장자는 PNG 포맷으로, WEBP는 WEBP 포맷으로, 그 외(JPG, JPEG, GIF 등)는 JPEG 포맷으로 반환한다.
     *
